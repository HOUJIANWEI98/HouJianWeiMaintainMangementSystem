...
import static com.util.common.Constants.RESUMETABLE;
...
import com.dao.provider.ResumeDynaSqlProvider;
...
public interface ResumeDao {
	...
	@Results({
			...
			@Result(column="sex_id",property="sex",
					one=@One(select="com.dao.SexDao.get_Info",
							fetchType=FetchType.EAGER)),
			@Result(column="education_id",property="education",
					one=@One(select="com.dao.EducationDao.get_Info",
							fetchType=FetchType.EAGER)),
			@Result(column="status_id",property="status",
					one=@One(select="com.dao.StatusDao.get_Info",
							fetchType=FetchType.EAGER))
	})
