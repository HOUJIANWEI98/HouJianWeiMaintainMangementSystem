...
import static com.util.common.Constants.COMPLETIONTABLE;
import static com.util.common.Constants.TRAINTABLE;
...
import com.dao.provider.TrainDynaSqlProvider;
...
public interface TrainDao {
	...
	@Results({
			...
			@Result(column="completion",property="completion",
					one=@One(select="com.dao.CompletionDao.get_Info",
							fetchType=FetchType.EAGER))
	})
