...
import static com.util.common.Constants.CONFIDENTIALITYCONTRACTTABLE;
import static com.util.common.Constants.CONTRACTTABLE;
...
import static com.util.common.Constants.LABORCONTRACTTABLE;
...
import com.dao.provider.ContractDynaSqlProvider;
...
public interface ContractDao {
	...
	@Results({
			...
			@Result(column="TRAIN_CONTRACT",property="trainContract",
					one=@One(select="com.dao.TraincontractDao.get_Info",
							fetchType=FetchType.EAGER)),
			@Result(column="LABOR_CONTRACT",property="laborContract",
					one=@One(select="com.dao.LaborcontractDao.get_Info",
							fetchType=FetchType.EAGER)),
			@Result(column="CONFIDENTIALITY_CONTRACT",property="confidentialityContract",
					one=@One(select="com.dao.ConfidentialitycontractDao.get_Info",
							fetchType=FetchType.EAGER)),
			@Result(column="DEPT_ID",property="dept",
					one=@One(select="com.dao.DeptDao.get_Info",
							fetchType=FetchType.EAGER)),
			@Result(column="EMP_ID",property="employee",
					one=@One(select="com.dao.EmployeeDao.get_Info",
							fetchType=FetchType.EAGER)),
			@Result(column="JOB_ID",property="job",
					one=@One(select="com.dao.JobDao.get_Info",
							fetchType=FetchType.EAGER))
	})
