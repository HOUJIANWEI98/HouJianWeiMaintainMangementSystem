...
import static com.util.common.Constants.RECRUITMENTTABLE;
...
import com.dao.provider.RecruitmentDynaSqlProvider;
...
public interface RecruitmentDao {
	...
	@Results({
			...
			@Result(column="jobtype",property="jobtype",
					one=@One(select="com.dao.JobTypeDao.get_Info",
							fetchType=FetchType.EAGER)),
			@Result(column="status",property="status",
					one=@One(select="com.dao.RecruitmentStatusDao.get_Info",
							fetchType=FetchType.EAGER))
	})
