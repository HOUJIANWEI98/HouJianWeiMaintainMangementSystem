...
import static com.util.common.Constants.TRAINDATATABLE;
...
import com.dao.provider.TrainDataDynaSqlProvider;
import com.pojo.TrainData;
public interface TrainDataDao {
	...
	@Results({
			...
			@Result(column="USER_ID",property="user",
					one=@One(select="com.dao.UserDao.get_Info",
