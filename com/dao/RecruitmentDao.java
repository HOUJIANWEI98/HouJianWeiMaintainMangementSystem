...
import static ahualy.neepu.util.common.Constants.RECRUITMENTTABLE;
import static ahualy.neepu.util.common.Constants.JOBTYPETABLE;
import static ahualy.neepu.util.common.Constants.RECRUITMENTSTATUSTABLE;
...
import ahualy.neepu.dao.provider.RecruitmentDynaSqlProvider;
...
public interface RecruitmentDao {
	...
	//查询
		...
		@Results({
			...
			one=@One(select="ahualy.neepu.dao.JobTypeDao.get_Info",
			fetchType=FetchType.EAGER)),
			@Result(column="status",property="status",
			one=@One(select="ahualy.neepu.dao.RecruitmentStatusDao.get_Info",
		fetchType=FetchType.EAGER))
		})
